...
let customScreen = {
  ...
  queryAllByShadowRole: (...args: ScreenShadowRoleMatcherParams) =>
    queryAllByShadowRole(document.documentElement, args[0], args[1]),
  queryByShadowRole: (...args: ScreenShadowRoleMatcherParams) =>
    queryByShadowRole(document.documentElement, args[0], args[1]),
  getAllByShadowRole: (...args: ScreenShadowRoleMatcherParams) =>
    getAllByShadowRole(document.documentElement, args[0], args[1]),
  getByShadowRole: (...args: ScreenShadowRoleMatcherParams) =>
    getByShadowRole(document.documentElement, args[0], args[1]),
  findAllByShadowRole: (...args: AsyncScreenShadowRoleMatcherParams) =>
    findAllByShadowRole(document.documentElement, args[0], args[1], args[2]),
  findByShadowRole: (...args: AsyncScreenShadowRoleMatcherParams) =>
    findByShadowRole(document.documentElement, args[0], args[1], args[2]),

  // Label Text
  queryAllByShadowLabelText: (...args: ScreenShadowSelectorMatcherParams) =>
    queryAllByShadowLabelText(document.documentElement, args[0], args[1]),
  queryByShadowLabelText: (...args: ScreenShadowSelectorMatcherParams) =>
    queryByShadowLabelText(document.documentElement, args[0], args[1]),
  getAllByShadowLabelText: (...args: ScreenShadowSelectorMatcherParams) =>
    getAllByShadowLabelText(document.documentElement, args[0], args[1]),
  getByShadowLabelText: (...args: ScreenShadowSelectorMatcherParams) =>
    getByShadowLabelText(document.documentElement, args[0], args[1]),
  ...
  findByShadowLabelText: (...args: AsyncScreenShadowSelectorMatcherParams) =>
    findByShadowLabelText(document.documentElement, args[0], args[1], args[2]),

  // Placeholder Text
  queryAllByShadowPlaceholderText: (...args: ScreenShadowMatcherParams) =>
    queryAllByShadowPlaceholderText(document.documentElement, args[0], args[1]),
  queryByShadowPlaceholderText: (...args: ScreenShadowMatcherParams) =>
    queryByShadowPlaceholderText(document.documentElement, args[0], args[1]),
  getAllByShadowPlaceholderText: (...args: ScreenShadowMatcherParams) =>
    getAllByShadowPlaceholderText(document.documentElement, args[0], args[1]),
  getByShadowPlaceholderText: (...args: ScreenShadowMatcherParams) =>
    getByShadowPlaceholderText(document.documentElement, args[0], args[1]),
  ...
  queryAllByShadowText: (...args: ScreenShadowSelectorMatcherParams) =>
    queryAllByShadowText(document.documentElement, args[0], args[1]),
  queryByShadowText: (...args: ScreenShadowSelectorMatcherParams) =>
    queryByShadowText(document.documentElement, args[0], args[1]),
  getAllByShadowText: (...args: ScreenShadowSelectorMatcherParams) =>
    getAllByShadowText(document.documentElement, args[0], args[1]),
  getByShadowText: (...args: ScreenShadowSelectorMatcherParams) =>
    getByShadowText(document.documentElement, args[0], args[1]),
  findAllByShadowText: (...args: AsyncScreenShadowSelectorMatcherParams) =>
    findAllByShadowText(document.documentElement, args[0], args[1], args[2]),
  findByShadowText: (...args: AsyncScreenShadowSelectorMatcherParams) =>
    findByShadowText(document.documentElement, args[0], args[1], args[2]),

  // Display Value
  queryAllByShadowDisplayValue: (...args: ScreenShadowMatcherParams) =>
    queryAllByShadowDisplayValue(document.documentElement, args[0], args[1]),
  queryByShadowDisplayValue: (...args: ScreenShadowMatcherParams) =>
    queryByShadowDisplayValue(document.documentElement, args[0], args[1]),
  getAllByShadowDisplayValue: (...args: ScreenShadowMatcherParams) =>
    getAllByShadowDisplayValue(document.documentElement, args[0], args[1]),
  getByShadowDisplayValue: (...args: ScreenShadowMatcherParams) =>
    getByShadowDisplayValue(document.documentElement, args[0], args[1]),
  ...
  queryAllByShadowAltText: (...args: ScreenShadowMatcherParams) =>
    queryAllByShadowAltText(document.documentElement, args[0], args[1]),
  queryByShadowAltText: (...args: ScreenShadowMatcherParams) =>
    queryByShadowAltText(document.documentElement, args[0], args[1]),
  getAllByShadowAltText: (...args: ScreenShadowMatcherParams) =>
    getAllByShadowAltText(document.documentElement, args[0], args[1]),
  getByShadowAltText: (...args: ScreenShadowMatcherParams) =>
    getByShadowAltText(document.documentElement, args[0], args[1]),
  findAllByShadowAltText: (...args: AsyncScreenShadowMatcherParams) =>
    findAllByShadowAltText(document.documentElement, args[0], args[1], args[2]),
  findByShadowAltText: (...args: AsyncScreenShadowMatcherParams) =>
    findByShadowAltText(document.documentElement, args[0], args[1], args[2]),

  // Title
  queryAllByShadowTitle: (...args: ScreenShadowMatcherParams) =>
    queryAllByShadowTitle(document.documentElement, args[0], args[1]),
  queryByShadowTitle: (...args: ScreenShadowMatcherParams) =>
    queryByShadowTitle(document.documentElement, args[0], args[1]),
  getAllByShadowTitle: (...args: ScreenShadowMatcherParams) =>
    getAllByShadowTitle(document.documentElement, args[0], args[1]),
  getByShadowTitle: (...args: ScreenShadowMatcherParams) =>
    getByShadowTitle(document.documentElement, args[0], args[1]),
  findAllByShadowTitle: (...args: AsyncScreenShadowMatcherParams) =>
    findAllByShadowTitle(document.documentElement, args[0], args[1], args[2]),
  findByShadowTitle: (...args: AsyncScreenShadowMatcherParams) =>
    findByShadowTitle(document.documentElement, args[0], args[1], args[2]),

  // Test Id
  queryAllByShadowTestId: (...args: ScreenShadowMatcherParams) =>
    queryAllByShadowTestId(document.documentElement, args[0], args[1]),
  queryByShadowTestId: (...args: ScreenShadowMatcherParams) =>
    queryByShadowTestId(document.documentElement, args[0], args[1]),
  getAllByShadowTestId: (...args: ScreenShadowMatcherParams) =>
    getAllByShadowTestId(document.documentElement, args[0], args[1]),
  getByShadowTestId: (...args: ScreenShadowMatcherParams) =>
    getByShadowTestId(document.documentElement, args[0], args[1]),
  findAllByShadowTestId: (...args: AsyncScreenShadowMatcherParams) =>
    findAllByShadowTestId(document.documentElement, args[0], args[1], args[2]),
  findByShadowTestId: (...args: AsyncScreenShadowMatcherParams) =>
    findByShadowTestId(document.documentElement, args[0], args[1], args[2]),
};
